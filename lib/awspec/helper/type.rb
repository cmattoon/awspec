  ...
  module Helper
    module Type
      ...
      TYPES = %w[
        ...
        iam_policy iam_role iam_user imagebuilder_component imagebuilder_pipeline imagebuilder_recipe kinesis kms lambda launch_configuration launch_template mq nat_gateway
